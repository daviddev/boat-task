...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'boat_models' => \App\GraphQL\Queries\BoatModel\BoatModelsQuery::class,
                'boat' => \App\GraphQL\Queries\Boat\BoatQuery::class,
                'boats' => \App\GraphQL\Queries\Boat\BoatsQuery::class,
            ],
            'mutation' => [
            ...
            'types' => [
                ...
                'BoatModel' => \App\GraphQL\Types\BoatModelType::class,
                'BoatImage' => \App\GraphQL\Types\BoatImageType::class,
            ],
